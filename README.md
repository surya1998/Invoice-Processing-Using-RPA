...
## MODULE SPLITUP:
Module 1: Create a  invoice template.
Module 2:Attach a template into email.
Module 3:Read a unread message using UiPath.
Module 4:Split it into a folder.
Module 5:Create a flow for all invoice.
Module 6:Convert those invoice from PDF to Excel sheet.
